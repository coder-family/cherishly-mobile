...
//           <Text style={styles.text}>You can now log in with your new password.</Text>
...
//     }
//     return (
//       <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.centeredContainer}>
//         <Text style={styles.title}>Password Reset Successful!</Text>
//         <Text style={styles.text}>You can now log in with your new password.</Text>
//         <TouchableOpacity style={styles.button} onPress={() => router.push('/login')}>
//           <Text style={styles.buttonText}>Go to Login</Text>
...
//           returnKeyType="next"
//           blurOnSubmit={false}
//           {...(Platform.OS === 'web' && !showPassword ? { type: 'password' } : {})}
//         />
//         <TouchableOpacity
...
//           {...(Platform.OS === 'web' && !showConfirm ? { type: 'password' } : {})}
//         />
//         <TouchableOpacity
//           style={styles.eyeButton}
